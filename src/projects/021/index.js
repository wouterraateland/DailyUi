            ...
            <svg className="Project-021-graph" viewBox="0 0 192 64">
              <defs>
                <linearGradient id="gradient" x1="0" x2="0" y1="0" y2="64" gradientUnits="userSpaceOnUse">
                  <stop offset="0" stopColor="#f43b4a"/>
                  <stop offset="1" stopColor="#f43b4a" stopOpacity="0"/>
                </linearGradient>
              </defs>
        ...
        <div className="Project-021-widget col-8">
          ...
          <div className="Project-021-widget-inner">
            ...
            <svg className="Project-021-graph" viewBox="0 0 192 64">
              ...
              <g className="Project-021-graph-group">
                <path fill="url(#gradient)" fillRule="evenodd" d="M192 40C140.43 24.753 127.415 12.893 96 16 67.36 18.833 46.18 55.418.34 32L0 64h192z"/>
